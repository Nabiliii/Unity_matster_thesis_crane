...
namespace realvirtual
{
    ...
    EditorUtility.DisplayDialog("Info",
        ...
        static void AddTwinCATInterface()
        {
            ...
            if (find.Length > 0)
                AddComponent("Assets/realvirtual/private/Interfaces/TwinCAT/TwinCATInterface.prefab");
            else
            {
                EditorUtility.DisplayDialog("Warning",
        ...
        static void AddTwinCATHMIInterface()
        {
            ...
            if (find.Length > 0)
                AddComponent("Assets/realvirtual/private/Interfaces/TwinCATHMI/TwinCATHMIInterface.prefab");
            else
            {
                EditorUtility.DisplayDialog("Warning",
                    "This interface is only included in realvirtual.io Professional", "OK");
        ...
        static void AddUniversalRobots()
        {
            ...
            if (find.Length > 0)
                AddComponent("Assets/realvirtual/private/Interfaces/UniversalRobots/UniversalRobotsInterface.prefab");
            else
            {
                EditorUtility.DisplayDialog("Warning",
                    "This interface is only included in realvirtual.io Professional", "OK");
        ...
        static void AddRobotStudioInterface()
        {
            ...
            if (find.Length > 0)
                AddComponent("Assets/realvirtual/private/Interfaces/ABBRobotStudio/ABBRobotStudioInterface.prefab");
            else
            {
                EditorUtility.DisplayDialog("Warning",
                    "This interface is only included in realvirtual.io Professional", "OK");
        ...
        static void AddSharedMemoryInterface()
        {
            ...
            if (find.Length > 0)
                AddComponent("Assets/realvirtual/private/Interfaces/SharedMemory/SharedMemoryInterface.prefab");
        }
#endif
        ...
        static void AddPLCSimAdvancedInterface()
        {
            ...
            if (find.Length > 0)
                AddComponent("Assets/realvirtual/private/Interfaces/PLCSimAdvanced/PLCSIMAdvancedInterface.prefab");
            else
            {
                EditorUtility.DisplayDialog("Warning",
                    "This interface is only included in realvirtual.io Professional", "OK");
        ...
        static void AddSimulinkInterface()
        {
            ...
            if (find.Length > 0)
                AddComponent("Assets/realvirtual/private/Interfaces/Simulink/SimulinkInterface.prefab");
            else
            {
                EditorUtility.DisplayDialog("Warning",
                    "This interface is only included in realvirtual.io Professional", "OK");
        ...
        static void AddSiemensSimitInterface()
        {
            var find = AssetDatabase.FindAssets(
                "SimulinkInterface t:prefab");
            if (find.Length > 0)
                AddComponent("Assets/realvirtual/private/Interfaces/SiemensSimit/SiemensSimitInterface.prefab");
            else
            {
                EditorUtility.DisplayDialog("Warning",
                    "This interface is only included in realvirtual.io Professional", "OK");
        ...
        static void AddOPCUAInterface()
        {
            ...
            if (find.Length > 0)
                AddComponent("Assets/realvirtual/private/Interfaces/OPCUA4UNITY/OPCUAInterface.prefab");
            else
            {
                EditorUtility.DisplayDialog("Warning",
                    "This interface is only included in realvirtual.io Professional", "OK");
        ...
        static void AddRoboDKInterface()
        {
            ...
            if (find.Length > 0)
                AddComponent("Assets/realvirtual/private/Interfaces/RoboDK/RoboDKInterface.prefab");
            else
            {
                EditorUtility.DisplayDialog("Warning",
                    "This interface is only included in realvirtual.io Professional", "OK");
        ...
        static void AddPLCConnectInterface()
        {
            ...
            if (find.Length > 0)
                AddComponent("Assets/realvirtual/private/Interfaces/Modbus/ModbusInterface.prefab");
            else
            {
                EditorUtility.DisplayDialog("Warning",
                    "This interface is only included in realvirtual.io Professional", "OK");
        ...
        static void AddEthernetIPInterface()
        {
            ...
            if (find.Length > 0)
                AddComponent("Assets/realvirtual/private/Interfaces/EthernetIP/EthernetIPInterface.prefab");
            else
            {
                EditorUtility.DisplayDialog("Warning",
                    "This interface is only included in realvirtual.io Professional", "OK");
        ...
        static void AddMQTTInterface()
        {
            ...
            if (find.Length > 0)
                AddComponent("Assets/realvirtual/private/Interfaces/MQTT/MQTTInterface.prefab");
            else
            {
                EditorUtility.DisplayDialog("Warning",
                    "This interface is only included in realvirtual.io Professional", "OK");
        ...
        [MenuItem("realvirtual/Add Object/Interface/FMI-FMU (Pro)", false, 157)]
        static void AddFMIInterface()
        {
            var find = AssetDatabase.FindAssets(
                "FMU t:prefab");
            if (find.Length > 0)
                AddComponent("Assets/realvirtual/private/Interfaces/FMI/FMU.prefab");
            else
            {
                EditorUtility.DisplayDialog("Warning",
                    "This interface is only included in realvirtual.io Professional", "OK");
