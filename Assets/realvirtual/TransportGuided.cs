...
namespace realvirtual
{
    ...
    public class TransportGuided : realvirtualBehavior, IGuidedSurface
    {
        ...
        [HideInInspector] [SerializeField] BoxCollider collider;
        ...
        public void Init()
        {
            ...
            if (!Circular)
            {
                ...
                collider = Global.AddComponentIfNotExisting<BoxCollider>(this.gameObject);
                collider.size = new Vector3(Length, Height, Width);
                collider.center = new Vector3(Length / 2, -Height / 2 - DistanceCollider, 0);
        ...
        private void SetColliderSizeArc()
        {
            ...
            collider.center = new Vector3(sizex*0.5f, -Height * 0.5f, -sizez*0.5f+borz);
        }
